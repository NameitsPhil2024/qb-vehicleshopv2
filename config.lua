...
Config.PlateLetters  = 4 -- DONT CHANGE IT IF YOU DONT KNOW WHAT YOU DO
Config.PlateNumbers  = 4 -- DONT CHANGE IT IF YOU DONT KNOW WHAT YOU DO
Config.PlateUseSpace = false -- DONT CHANGE IT IF YOU DONT KNOW WHAT YOU DO

Config.SpawnVehicle = true  -- TRUE if you want spawn vehicle when buy

Config.TestDrive = true      -- TRUE if you want enable test drive
Config.TestDriveTime = 180   -- TIME in SEC 180 IS DEFAULT

Config.Blips = {
    [1] = {
        blip = vector3(-56.49, -1096.58, 26.42), -- Blip Position 
        blipname = 'Premium Deluxe Motorsport', -- Blip Name 
        blipsprite = 326, -- Blip Look (https://docs.fivem.net/docs/game-references/blips/) 
        blipcolor = 3 --Change Color here (https://docs.fivem.net/docs/game-references/blips/)
    },
    [2] = {
...
-- The Confi.Blips dont have anything to do with the Config.Shops
Config.Shops = {
    [1] = {
